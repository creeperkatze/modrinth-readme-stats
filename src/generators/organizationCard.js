...
<svg width="450" height="${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Organization Image (upper right) -->
  <defs>
    <clipPath id="org-clip">
      <circle cx="400" cy="60" r="35"/>
    </clipPath>
  </defs>
  ${organization.icon_url_base64 || organization.icon_url ? `<image x="365" y="25" width="70" height="70" href="${organization.icon_url_base64 || organization.icon_url}" clip-path="url(#org-clip)"/>` : `<circle cx="400" cy="60" r="35" fill="${borderColor}"/>`}
