...
export const ICONS = {
    ...
    purpur: (color = "currentColor") => `
        <defs>
            <path id="purpur" fill="none" stroke="${color}" stroke-width="1.68" stroke-linecap="round" stroke-linejoin="round" d="m264 41.95 8-4v8l-8 4v-8Z"/>
        </defs>
        <path fill="none" d="M0 0h24v24H0z"/>
        <path fill="none" stroke="${color}" stroke-width="1.77" stroke-linecap="round" stroke-linejoin="round" d="m264 29.95-8 4 8 4.42 8-4.42-8-4Z" transform="matrix(1.125 0 0 1.1372 -285 -31.69)"/>
        <path fill="none" stroke="${color}" stroke-width="1.77" stroke-linecap="round" stroke-linejoin="round" d="m272 38.37-8 4.42-8-4.42" transform="matrix(1.125 0 0 1.1372 -285 -31.69)"/>
        <path fill="none" stroke="${color}" stroke-width="1.77" stroke-linecap="round" stroke-linejoin="round" d="m260 31.95 8 4.21V45" transform="matrix(1.125 0 0 1.1372 -285 -31.69)"/>
        <path fill="none" stroke="${color}" stroke-width="1.77" stroke-linecap="round" stroke-linejoin="round" d="M260 45v-8.84l8-4.21" transform="matrix(1.125 0 0 1.1372 -285 -31.69)"/>
        <use href="#purpur" stroke="${color}" stroke-width="1.68" stroke-linecap="round" stroke-linejoin="round" transform="matrix(1.125 0 0 1.2569 -285 -40.78)"/>
        <use href="#purpur" stroke="${color}" stroke-width="1.68" stroke-linecap="round" stroke-linejoin="round" transform="matrix(-1.125 0 0 1.2569 309 -40.78)"/>
    `,
    ...
    `,
    geyser: (color = "currentColor") => `
        <path d="M-29.359 21.58s.347-4.964-2.603-9.503l3.419 1.511 2.032-4.165s.407 5.006.717 6.82l4.201-2.269s-3.582 5.066-3.339 7.726" fill="none" stroke="${color}" stroke-width="1.81" stroke-linecap="round" stroke-linejoin="round" transform="matrix(1.04036 0 0 1.1631 40.307 -2.368)"/>
